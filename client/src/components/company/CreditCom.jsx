        ...
        <div className="container mt-5 main-content">
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 mb-4">
                ...
                <div className="card-body d-flex flex-column credit-body">
                    ...
                    <a href="/company/credit/credit_detail_com?productNo=1" className="btn-long w-100 credit-option-btn">결제</a>
                </div>
                </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 mb-4">
                ...
                <div className="card-body d-flex flex-column credit-body">
                    ...
                    <a href="/company/credit/credit_detail_com?productNo=2" className="btn-long w-100 credit-option-btn">결제</a>
                </div>
                </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 mb-4">
                ...
                <div className="card-body d-flex flex-column credit-body">
                    ...
                    <a href="/company/credit/credit_detail_com?productNo=3" className="btn-long w-100 credit-option-btn">결제</a>
                </div>
                </div>
            </div>
