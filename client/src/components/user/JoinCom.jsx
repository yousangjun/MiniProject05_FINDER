            ...
            <main>
                <form className="register-form" onSubmit={handleSubmit}>
                    ...
                    <div className="img-file">
                        ...
                        <div style={{ textAlign: 'center' }}>
                            <button type="button" className="btn-short" onClick={() => document.getElementById('fileInput').click()}>파일 선택</button>
                    ...
                    <div className="phone">
                        <div className="d-flex justify-content">
                            ...
                            <select className="form-control" name="lastEmail" id="lastEmail" style={{ height: '45.6px' }} onChange={handleChange}>
